GROUP_ID = 'hpl_bo_new_code_test_0'
RANDOM_SEED = 0
...
'''
SYNTHETIC_TRAIN_ID_LIST = ['1', '2']
SYNTHETIC_TEST_ID_LIST = ['3', '4']
SYNTHETIC_FULL_ID_LIST = ['1', '2', '3', '4']
...
if IS_GCP:
    ...
    FITTING_NODE_CPU_COUNT = None
    BO_NODE_CPU_COUNT = None
    NLL_NODE_CPU_COUNT = None
