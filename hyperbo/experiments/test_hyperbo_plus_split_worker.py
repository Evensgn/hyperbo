...
def split_merge(dir_path, key, group_id, extra_info, train_id_list, test_id_list,
    ...
    with open(os.path.join(dir_path, 'results.txt'), 'w') as f:
        ...
        nll_results_a = results_a['nll_results']
        nll_results_b = results_b['nll_results']

        if gt_gp_distribution_params:
            f.write('setup a nll table\n')
            f.write(
                f'''
                \\begin{{tabular}}{{|c|l|l|}}
                    \\hline
                    Method       & \\multicolumn{{1}}{{c|}}{{NLL on Train}} & \multicolumn{{1}}{{c|}}{{NLL on Test}} \\\\ \\hline
                    misspecified & {nll_results_a['fixed_nll_on_train_mean']:.4g} \\pm {nll_results_a['fixed_nll_on_train_std']:.4g} & {nll_results_a['fixed_nll_on_test_mean']:.4g} \\pm {nll_results_a['fixed_nll_on_test_std']:.4g} \\\\ \\hline
                    groundtruth  & {nll_results_a['gt_nll_on_train_mean']:.4g} \\pm {nll_results_a['gt_nll_on_train_std']:.4g} & {nll_results_a['gt_nll_on_test_mean']:.4g} \\pm {nll_results_a['gt_nll_on_test_std']:.4g} \\\\ \\hline
                    HyperBO+     & {nll_results_a['gamma_nll_on_train_mean']:.4g} \\pm {nll_results_a['gamma_nll_on_train_std']:.4g} & {nll_results_a['gamma_nll_on_test_mean']:.4g} \\pm {nll_results_a['gamma_nll_on_test_std']:.4g} \\\\ \\hline
                \\end{{tabular}}
                '''
            )

            f.write('setup b nll table\n')
            f.write(
                f'''
                \\begin{{tabular}}{{|c|l|l|}}
                    \\hline
                    Method       & \\multicolumn{{1}}{{c|}}{{NLL on Train}} & \multicolumn{{1}}{{c|}}{{NLL on Test}} \\\\ \\hline
                    misspecified & {nll_results_b['fixed_nll_on_train_mean']:.4g} \\pm {nll_results_b['fixed_nll_on_train_std']:.4g} & {nll_results_b['fixed_nll_on_test_mean']:.4g} \\pm {nll_results_b['fixed_nll_on_test_std']:.4g} \\\\ \\hline
                    HyperBO      & {nll_results_b['hyperbo_nll_on_train_mean']:.4g} \\pm {nll_results_b['hyperbo_nll_on_train_std']:.4g} & {nll_results_b['hyperbo_nll_on_test_mean']:.4g} \\pm {nll_results_b['hyperbo_nll_on_test_std']:.4g} \\\\ \\hline
                    groundtruth  & {nll_results_b['gt_nll_on_train_mean']:.4g} \\pm {nll_results_b['gt_nll_on_train_std']:.4g} & {nll_results_b['gt_nll_on_test_mean']:.4g} \\pm {nll_results_b['gt_nll_on_test_std']:.4g} \\\\ \\hline
                    HyperBO+     & {nll_results_b['gamma_nll_on_train_mean']:.4g} \\pm {nll_results_b['gamma_nll_on_train_std']:.4g} & {nll_results_b['gamma_nll_on_test_mean']:.4g} \\pm {nll_results_b['gamma_nll_on_test_std']:.4g} \\\\ \\hline
                \\end{{tabular}}
                '''
            )
        else:
